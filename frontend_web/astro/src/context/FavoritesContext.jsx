...
export const FavoritesProvider = ({ children }) => {
  ...
  useEffect(() => {
    const loadFavorites = async () => {
      ...
      try {
        const response = await fetch(`https://astroglowfirebase-d2411.uc.r.appspot.com/api/favorites/user/${user.userId}/music-details`, {
          headers: {
  ...
  const toggleFavorite = useCallback(async (musicId) => {
    ...
    try {
      ...
      const checkResponse = await fetch(`https://astroglowfirebase-d2411.uc.r.appspot.com/api/favorites/user/${user.userId}/music/${encodeURIComponent(musicId)}/check`, {
        credentials: 'include'
      });
      ...
      if (isFavorited) {
        ...
        response = await fetch(`https://astroglowfirebase-d2411.uc.r.appspot.com/api/favorites/user/${user.userId}/music/${encodeURIComponent(musicId)}`, {
          method: 'DELETE',
          credentials: 'include'
        });
      } else {
